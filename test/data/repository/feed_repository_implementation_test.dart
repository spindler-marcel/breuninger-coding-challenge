...
void main() {
  ...
  DioException dioException(DioExceptionType type) => DioException(
        type: type,
        requestOptions: RequestOptions(),
      );
  ...
  group('getFeed', () {
    ...
    test('returns Failure(ParseFailure) when response body is not a list', () async {
      when(() => dio.get(any(), cancelToken: any(named: 'cancelToken')))
    ...
    test('calls correct URL for source1', () async {
      ...
      verify(() => dio.get(FeedSource.source1.url, cancelToken: any(named: 'cancelToken')))
          .called(1);
    });
    ...
    test('calls correct URL for source2', () async {
      ...
      verify(() => dio.get(FeedSource.source2.url, cancelToken: any(named: 'cancelToken')))
          .called(1);
    });
  });
  ...
  group('loadBrandItems', () {
    ...
    test('returns Failure(ParseFailure) when items value is not a list', () async {
      when(() => dio.get(any(), cancelToken: any(named: 'cancelToken')))
    ...
    test('calls the provided itemsUrl', () async {
      ...
      verify(() => dio.get(itemsUrl, cancelToken: any(named: 'cancelToken'))).called(1);
    });
  });
